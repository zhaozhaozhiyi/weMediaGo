...
class Api:
    ...
    def api_server_config(self) -> ServerConfigResponse:
        ...
        controlnet_method = ""
        if current_model.support_controlnet and current_model.controlnets:
            controlnet_method = current_model.controlnets[0]
        ...
        return ServerConfigResponse(
            ...
            enableControlnet=current_model.support_controlnet,
